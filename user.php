					...
					?>
						<div class="row" style="margin-top: 2%">
							<div class="col-md-10 col-md-offset-1">
								<h1>Witaj, <?php echo $fulluser; ?><form method="post" style="display:inline"><button type="submit" name="logout" class="btn btn-danger pull-right">Wyloguj</button></form><h1>		
									...
									<div class="panel panel-danger">
										...
										<div class="panel-body">	
											<h3>
												...
												<br>
												Zachęcamy do ponownego złożenia podania po upływie 7 dni.
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<form method="post" style="display:inline" action="sendapp.php">
									...
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Link do profilu forum</b>:<input type="text" name="app_forum" class="form-control" placeholder="Przyklad: https://strefarp.pl/member.php?action=profile&uid=xxxxx" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][1] : ""); ?>" required /></h3>
										<span style="font-size: 12px;">Na forum znajdziesz przycisk <b>"Twój profil"</b> w którym znajdziesz link </span>
									</div>
									...
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Czym dla Ciebie jest Roleplay?</b></h3>
										<textarea class="form-control" name="app_rp" rows="8" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][3] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Jakie postacie odgrywałeś wcześniej?</b></h3>
										<textarea class="form-control" name="app_pastrp" rows="8" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][4] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Jakie postacie zamierzasz odgrywać na naszym serwerze?</b></h3>
										<textarea class="form-control" name="app_currentrp" rows="8" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][5] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Streamujesz lub nagrywasz content na swoje kanały?<br>Jeśli tak, podaj linki, czy też nagrania z przykładem twojego RP.</b></h3>
										<textarea class="form-control" name="app_stream" rows="6" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][6] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Wyślij link do regulaminu oraz wskaż jego dobre i złe strony.</b></h3>
										<textarea class="form-control" name="app_rules" rows="8" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][7] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Sytuacja:<br>Okradasz sklep.<br>W środku znajduje się właściciel sklepu oraz cywil.<br>Obydwoje błagają abyś ich nie okradł lub nie zranił.<br>Jakbyś odegrał tą sytuację i jakie działania podjął?</b></h3>
										<textarea class="form-control" name="app_shop" rows="16" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][8] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Sytuacja:<br>Naprawiasz swój samochód na środku drogi,<br>ktoś podjeżdża od tyłu i zaczyna w ciebie celować z broni palnej.<br>Każą ci podnieść ręce i oddać kluczyki do samochodu.<br>Co byś zrobił w tej sytuacji i jak się zachował?</b></h3>
										<textarea class="form-control" name="app_car" rows="16" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][9] : ""); ?>" required></textarea>
									</div>
									
									<div class="well well-sm">
										<h3 style="margin-top: 10px; margin-bottom: 10px;"><b>Złowiłeś złotą rybkę, masz jedno życzenie, jak ono brzmi?</b></h3>
										<textarea class="form-control" name="app_fish" rows="12" value="<?php echo (isset($_SESSION['memoryarray']) ? $_SESSION['memoryarray'][10] : ""); ?>" required></textarea>
									</div>
